...
exports.analyzeCredit = analyzeCredit;
const FIXED_INSTALLMENTS = 12;
const MAX_COMMITMENT_RATE = 0.3;
const MINIMUM_AGE = 18;
function analyzeCredit(input) {
    const reasons = [];
    const monthlyInstallment = input.loanAmount / FIXED_INSTALLMENTS;
    const commitmentRate = input.monthlyIncome > 0 ? monthlyInstallment / input.monthlyIncome : Infinity;
